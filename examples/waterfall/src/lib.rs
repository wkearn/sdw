...
impl State {
	...
	let data2 = &starboard_data[(idx * 4340)..((idx + 1024) * 4340)];
	 ...
	 queue.write_texture(
        ...
        let port_texture_view =
            port_texture.create_view(&wgpu::TextureViewDescriptor::default());
        let port_sampler = device.create_sampler(&wgpu::SamplerDescriptor {
	...
	let starboard_texture_view =
            starboard_texture.create_view(&wgpu::TextureViewDescriptor::default());
        let starboard_sampler = device.create_sampler(&wgpu::SamplerDescriptor {
            address_mode_u: wgpu::AddressMode::ClampToEdge,
            address_mode_v: wgpu::AddressMode::ClampToEdge,
            address_mode_w: wgpu::AddressMode::ClampToEdge,
            mag_filter: wgpu::FilterMode::Linear,
        ...
        let port_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                wgpu::BindGroupEntry {
                    binding: 0,
                    resource: wgpu::BindingResource::TextureView(&port_texture_view),
                },
                wgpu::BindGroupEntry {
                    binding: 1,
                    resource: wgpu::BindingResource::Sampler(&port_sampler),
                },
            ],
	...
	let starboard_bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
            ...
            entries: &[
                wgpu::BindGroupEntry {
                    binding: 0,
                    resource: wgpu::BindingResource::TextureView(&starboard_texture_view),
                },
                wgpu::BindGroupEntry {
                    binding: 1,
                    resource: wgpu::BindingResource::Sampler(&starboard_sampler),
                },
            ],
	...
	self.queue.write_texture(
            wgpu::ImageCopyTexture {
                texture: &self.starboard_texture,
                mip_level: 0,
                origin: wgpu::Origin3d::ZERO,
                aspect: wgpu::TextureAspect::All,
            },
